...
function twentytwenty_register_styles() {
	...
	// Add webpage stylesheet
	wp_enqueue_style( 'mx3-group-style', get_template_directory_uri() . "/build/css/mx3-group.css", array(), $theme_version );
...
function twentytwenty_register_scripts() {
	...
	wp_enqueue_script( 'mx3-group-js', get_template_directory_uri() . '/build/js/script-bundle.min.js', array(), $theme_version, true );
	wp_script_add_data( 'mx3-group-js', 'async', true );
...
function prefix_theme_class($content = '') {
	$theme_className = "";

	if(function_exists('wp_get_theme')){
		$theme_className = wp_get_theme()->get( 'TextDomain' );
	}

	return $theme_className . $content;
}
